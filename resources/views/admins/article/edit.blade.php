    ...
    <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
        <div class="widget am-cf">
            <div class="widget-head am-cf">
                <div class="widget-title am-fl">文章修改</div>
            ...
            <div class="widget-body am-fr">
                ...
                {{--<form action="{{url('admin/article/'.$art->art_id)}}" method="post" id="art_form" enctype="multipart/form-data" class="am-form tpl-form-line-form" >--}}
                <form action="{{url('admin/article/'.$art->art_id)}}" method="post" id="art_form" enctype="multipart/form-data" class="am-form tpl-form-line-form" >
                ...
                <div class="am-form-group">
                    ...
                    <div class="am-form-group">
                        ...
                        <div class="am-u-sm-9">
                            <input type="text" placeholder="文章标题" id="user-name" name="art_title" value="{{$art->art_title}}" class="tpl-form-input">
                    ...
                    <div class="am-form-group">
                        ...
                        <div class="am-u-sm-9">
                            <input type="text" placeholder="文章编辑" id="user-name" name="art_editor" value="{{$art->art_editor}}" class="tpl-form-input">
                    ...
                    <div class="am-form-group">
                        ...
                        <div class="am-u-sm-9">
                            <input type="text" size="50" name="art_thumb" placeholder="缩略图" id="art_thumb" value="{{$art->art_thumb}}">
...
//                                        本地服务器
                    ...
                    <div class="am-form-group">
                        ...
                        <div class="am-u-sm-9">
                            <input type="text" placeholder="文章标签" id="user-name" name="art_tag" value="{{$art->art_tag}}" class="tpl-form-input">
                    ...
                    <div class="am-form-group">
                        ...
                        <div class="am-u-sm-9">
                            <textarea placeholder="描述" name="art_description" id="user-intro" rows="10" class="" style="height: 136px;">{{$art->art_description}}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="am-form-group">
                        ...
                        <div class="am-u-sm-9">
                            ...
                            <script id="editor" name="art_content" type="text/plain" style="width:850px;height:300px;">
                                {{$art->art_content}}
